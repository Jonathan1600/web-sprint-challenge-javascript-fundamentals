...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
//It is able to access the variable internal because of closure, it goes and looks for it on his own function but when it identifies that it doesnt has it goes ahead and looks for it in the parent function and finds it. That procedure is called closure.
...
function USApop(/*Your Code Here*/) {
  return zooAnimals.reduce((x, animal) => (x += animal.population), 0);
}
